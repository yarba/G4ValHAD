...
#
# NOTE: as of 10.4.ref07, G4INCLDATA is also needed although it doesn't seem mandatory (yet)
#
dslist=(G4LEDATA G4LEVELGAMMADATA G4NEUTRONHPDATA G4RADIOACTIVEDATA G4ABLADATA G4REALSURFACEDATA G4PIIDATA G4SAIDXSDATA G4INCLDATA G4ENSDFSTATEDATA G4PARTICLEXSDATA)
#
