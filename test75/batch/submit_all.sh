...
# ---> PBS/obsolete --->    qsub -q amd32_g4val -l nodes=1:slow,walltime=12:00:00 -v G4RELEASE=${g4version},G4REGRESSION=${2} -A g4p ${test}
sbatch -p amd32_g4val_slow -t 12:00:00 --export="G4RELEASE=${g4version},G4REGRESSION=${2}" -A g4p ${test}
done
