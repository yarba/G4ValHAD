...
// new - for test47
//
// Note: it's here and NOT in test47 (Tst47Reader) because it'll then be
//       needed by ExecProcessLevel which is a common-use;
//       same applies to other pieces that are "new for test47"
//
      G4double        GetAngleX()         const { return fAngleX; }       
      G4double        GetdAngleX()        const { return fdAngleX; }
      G4double        GetAngleY()         const { return fAngleY; }
      G4double        GetdAngleY()        const { return fdAngleY; }
      G4double        GetBeamSigmaX()     const { return fBeamSigmaX; }
      G4double        GetBeamSigmaY()     const { return fBeamSigmaY; }
